...
Thank you for being all the small joys and the big magic. Happy birthday, my love. I hope this year is gentle with your heart and wildly good to you.`,
  chapters: [
    { id: "happy", emoji: "☀️", label: "happy", feeling: "the grin you give me", message: "Nanna, i am so so so happy you came in to my life. The moments we shared from the day we met are so speciallllllllll to me. I always want to see you happy. nuvu navvuthu unte naku chala istammmmm", photo: "happy.jpg.png?v=2" },
    { id: "love", emoji: "💛", label: "love", feeling: "the obvious one", message: "Mahiii gurtunda nuvu naku propose chesina roju,dont say i said no to you .nenu ah roju no cheppina ne meedha istam naku undedhi and obviously i said yes within a month.Inkosari evaridaggaraina chala kastapadda nannu padeydaniki annav anuko champestha.easy ga dorikina bangaram ra nenu😁😁😁😁. Nanna i love you so muchhhhhhhhhhhhh. I am so glad that i have you in my life.", photo: "love.jpg.png?v=2" },
    { id: "tired", emoji: "🌙", label: "exhausted", feeling: "for your soft days", message: "When the day asks too much of you, come here. You don't have to be impressive with me. Mahiii baga gurtupettuko moni undi neeku ,nuvu ela unna emaina thanu neethone untundi last varaku eppudu vadili velladhu", photo: "exhausted.jpg.png" },
    { id: "missed", emoji: "🫶", label: "missed", feeling: "when you're away", message: "I know while seeing this you gonna miss me so lotsss of hugs and ummmahhhhs from me. eppudaina baga miss aithe mana photos chustha mahi,while seeing those photos everytime i see the happiest version of me with you. Thankyou so much nanna.", photo: "missed.jpg.png" }
  ]
};
